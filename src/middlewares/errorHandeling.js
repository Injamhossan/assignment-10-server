...
const errorHandler = (err, req, res, next) => {
  ...
  if (process.env.NODE_ENV === 'development') {
    ...
    // FIX: The spread operator ({ ...err }) often fails to copy non-enumerable properties
    // like 'name' from an Error instance, preventing the error type checks from running.
    let error = { ...err };
    error.name = err.name; // Explicitly copy the 'name' property
